...
/**
 * This class creates Merge script. User have to prepare data in Excel file and name of the worksheet must have to be same as Table name.
 * Input : First provide table name, then provide name of the columns,separated by pipe, to satisfy table constraint.
 * Note  : If unique key contains all the columns then please comment code delimited by (NO_UPDATE_REQUIRED) 
 * Table name has to be entered by user.
 * Provide data in EXCEL like a database table.
 * @author ah0666039
 */
public class MergeScriptGenerator {
	public static final String inputFilePath = "C:/Users/ah0666039/Desktop/MIL_LABEL_MISS.xls";
//	public static final String inputFilePath = "C:/Users/ah0666039/Desktop/CICscripts/cstm_ques/ATC-1458.xls";
	public static final String outputFolderPath = "C:/my360Workspaces/360Jul15/ScriptGenerator/SQLScript/MILITARY/";
...
//		            	NO_UPDATE_REQUIRED
				        ...
				        if(createScriptFlag) {
					        PrintWriter writer = new PrintWriter(outputFolderPath  + "ATC-1458_" + tblName + "_DML.sql", "UTF-8");
